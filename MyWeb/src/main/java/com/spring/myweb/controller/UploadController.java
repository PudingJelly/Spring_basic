...
public class UploadController {
	...
	public void upload(MultipartFile file) {
		...
		long size = file.getSize(); // 바이트 단위의 파일 크기
		...
		/*
		 ...
		 사용자가 업로드 하는 파일명이 영어 이외의 언어로 되어있을 수도 있습니다.
		 타 언어를 지원하지 않는 환경에서는 정상 동작이 되지 않을 수 있습니다. (ex 리눅스)
