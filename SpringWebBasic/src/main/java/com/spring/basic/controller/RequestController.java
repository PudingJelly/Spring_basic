...
@Controller
@RequestMapping("/request") // 컨트롤러 자체에 공통괸 URI 맵핑
public class RequestController {

	public RequestController() {
		System.out.println("RequestCon 요청이 들어옴!");		
	}
   ...
   */
	...
	// 요청이 들어온 URL 값을 뷰 지졸버에게 전달합니다.
	@GetMapping("/join")
	public void resister() {
		System.out.println("/request/join: GET");
	}
	
	// 요청 URI 주소가 같더라도, 전송 방식에 다라 맵핑을 다르게 하기 때문에
	// 같은 주소를 사용하는 것이 가능합니다.(GET -> 화면처라, POST -> 입력값 처리)	
	
	/*
	 # 스프링에서 요청과 합께 전달된 데이터를 처리하는 방식
	...
	@PostMapping("/join")
	public void resister(HttpServletRequest request) {
...
//	@PostMapping("/join")
//	public void resister(@RequestParam("userId") String id,
...
///////////////////////////////////////////////////////////////////////////////////
	...
	@PostMapping("/join")
	public void resister(String userId,
						 String userPw,
